...
case $release in 
	...
	"Ubuntu")
		...
		packages+=" i3-wm i3blocks i3lock suckless-tools scrot alsa-utils sysstat acpi feh xbacklight rxvt-unicode adapta-gtk-theme papirus-icon-theme lxappearance"
